...
public class Thanksgiving extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent favorites = new Intent(Thanksgiving.this, Prayer_topics.class);
        ...
        linearLayoutManager = new LinearLayoutManager(Thanksgiving.this,
                LinearLayoutManager.VERTICAL, false);
        memoAdapter = new MemoAdapter(Thanksgiving.this);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == RESULT_OK)
                    {
                        ...
                        // 목록 갱신
                        memoAdapter.notifyDataSetChanged();
                        Toast.makeText(Thanksgiving.this, "Save complete.", Toast.LENGTH_SHORT).show();
                        Log.e(TAG, "intent : " + intent);
                        Uri uri = intent.getData();
                    } else { // RESULT_CANCEL
                        Toast.makeText(Thanksgiving.this, "Not saved.", Toast.LENGTH_SHORT).show();
                    }
                }
            });
