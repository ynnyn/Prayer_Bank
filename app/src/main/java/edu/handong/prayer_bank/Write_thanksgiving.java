...
public class Write_thanksgiving extends AppCompatActivity {
    long pNow;
    Date pDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_thanksgiving);
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String save_form = "{\"category\":\"" + edit_category + "\",thanksgiving\":\""+edit_pt+"\"}";
                ...
                Log.d("Write_thanksgivingActivity", "감사일기 : "+edit_pt+", 현재시간 : "+getTime);
                ...
                intent.putExtra("thanksgiving",edit_pt);
